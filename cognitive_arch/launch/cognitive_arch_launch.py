...
def generate_launch_description():
    ...
    example_dir = get_package_share_directory('cognitive_arch')
    ...
    plansys2_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
          'model_file': example_dir + '/pddl/cognitive_domain.pddl',
          'namespace': namespace
          }.items())
    ...
    search_cmd = Node(
      ...
      parameters=[
        example_dir + '/config/params.yaml',
        {
          ...
          'publisher_port': 1690,
          'server_port': 1691,
          'bt_xml_file': example_dir + '/behavior_trees_xml/search.xml'
        }
      ])
